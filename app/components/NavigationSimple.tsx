...
export default function NavigationSimple({ bw = false }: NavigationSimpleProps) {
  ...
  return (
    <>
      <nav className={`fixed top-0 left-0 w-full z-50 px-6 md:px-8 py-3 md:py-0 flex items-center justify-between bg-transparent border-b-2 border-transparent min-h-[12vh] md:min-h-[12vh] transition-transform duration-300 ${isHidden ? "-translate-y-full" : ""}`}>
